          ...
          <Block  flex={1}>
            ...
            <Block flex={1.5} style={{marginLeft:70}} >
              ...
              <Block row style={{marginTop:20}} >
                  <Icon size={25} name="wallet" family="Entypo" color={theme.COLORS.MUTED}/>
                  <Text style={styles.textContent}>{this.state.salary} € de revenu généré</Text>
              </Block>
            </Block>
...
export default connect(mapStateToProps)(MyAccountWorker)