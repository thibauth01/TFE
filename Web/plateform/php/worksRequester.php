                                ...
                                <div class="card-body">
                                    <div class="table-full-width table-responsive">
                                        <table class="table">
                                            <tbody>
                                                <?php
                                                    $WorkQuery = $dbh->query("  SELECT title, id_type, description, id_requester, min_age_worker, date_start, time_start, time_end, place, statut_progress, name 
                                                                                FROM work JOIN type_work 
                                                                                ON work.id_type = type_work.id 
                                                                                WHERE id_requester = 6 AND id_worker is NULL AND finish = 0 AND cancelled =0 ");
